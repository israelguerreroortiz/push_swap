...
/*   Updated: 2025/02/02 17:39:01 by iisraa11         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cost calculate_cost(stack_node **a, stack_node **b, int index_b) {
    ...
    cost.cost_b = (index_b <= size_b / 2) ? index_b : index_b - size_b;
    cost.cost_b = abs(cost.cost_b); // Ensure cost_b is always positive
